...
function* api_v1_test_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_test_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_test_listFailed(err, action))
  }
}
...
function* api_v1_test_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_test_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_test_createFailed(err, action))
  }
}
...
function* api_v1_test_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_test_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_test_readFailed(err, action))
  }
}
...
function* api_v1_test_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_test_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_test_updateFailed(err, action))
  }
}
...
function* api_v1_test_partial_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_test_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_test_partial_updateFailed(err, action))
  }
}
...
function* api_v1_test_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_test_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_test_deleteFailed(err, action))
  }
}
...
export default function* rootSaga() {
  const sagas = [
    plugin50_get__readWatcher,
    plugin50_post_data_g1_createWatcher,
