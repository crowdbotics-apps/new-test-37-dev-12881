...
export const api_v1_test_list = () => ({ type: types.API_V1_TEST_LIST })
export const api_v1_test_listSucceeded = (response, starter) => ({
  type: types.API_V1_TEST_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_test_listFailed = (error, starter) => ({
  type: types.API_V1_TEST_LIST_FAILED,
  error,
  starter
})
export const api_v1_test_create = data => ({
  type: types.API_V1_TEST_CREATE,
  data
})
export const api_v1_test_createSucceeded = (response, starter) => ({
  type: types.API_V1_TEST_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_test_createFailed = (error, starter) => ({
  type: types.API_V1_TEST_CREATE_FAILED,
  error,
  starter
})
export const api_v1_test_read = () => ({ type: types.API_V1_TEST_READ })
export const api_v1_test_readSucceeded = (response, starter) => ({
  type: types.API_V1_TEST_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_test_readFailed = (error, starter) => ({
  type: types.API_V1_TEST_READ_FAILED,
  error,
  starter
})
export const api_v1_test_update = data => ({
  type: types.API_V1_TEST_UPDATE,
  data
})
export const api_v1_test_updateSucceeded = (response, starter) => ({
  type: types.API_V1_TEST_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_test_updateFailed = (error, starter) => ({
  type: types.API_V1_TEST_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_test_partial_update = data => ({
  type: types.API_V1_TEST_PARTIAL_UPDATE,
  data
})
export const api_v1_test_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_TEST_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_test_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_TEST_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_test_delete = () => ({ type: types.API_V1_TEST_DELETE })
export const api_v1_test_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_TEST_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_test_deleteFailed = (error, starter) => ({
  type: types.API_V1_TEST_DELETE_FAILED,
  error,
  starter
})
